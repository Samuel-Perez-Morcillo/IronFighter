class EndScreen1 {
    ...
    createElement() {
        ...
        this.gameOverElement.style.opacity = '0px'
        ...
        this.phraseElement.innerText = 'PLAYER 1 WINS'
        this.phraseElement.style.position = 'absolute'
        this.phraseElement.style.color = 'red'
        ...
        document.querySelector('#end-screen1').appendChild(this.gameOverElement)
        document.querySelector('#end-screen1').appendChild(this.buttonElement)
        document.querySelector('#end-screen1').appendChild(this.phraseElement)
